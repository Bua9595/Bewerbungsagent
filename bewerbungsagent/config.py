...
class Config:
    ...
    def __init__(self):
        ...
        self.TEMPLATES_FILE = os.path.join("data", "bewerbungsvorlagen.txt")

        self.TRACKING_FILE = os.path.join("data", "bewerbungen_tracking.csv")
    ...
    def load_from_env(self):
        ...
        if env_max_jobs:
            try:
                self.EMAIL_MAX_JOBS = int(env_max_jobs)
            except ValueError:
                pass
